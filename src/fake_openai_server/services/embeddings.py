...
def load_sentence_transformer(model_name: str) -> SupportsEmbeddingsModel:
    """Load the default sentence-transformer embeddings backend."""

    from sentence_transformers import SentenceTransformer

    return cast(SupportsEmbeddingsModel, SentenceTransformer(model_name))
...
class EmbeddingsService:
    ...
    def __init__(
        ...
        *,
        model_name: str,
        model_loader: Callable[[str], SupportsEmbeddingsModel] = (
